...
![](images/THA-14.png)
**Retrieving the five study areas**
Changi
```{r}
ch <- mpsz_sf %>%
...
<li class="tab active" onclick="showTab(&#39;tab1&#39;)">

Changi

</li>

<li class="tab" onclick="showTab(&#39;tab2&#39;)">

Town

</li>

<li class="tab" onclick="showTab(&#39;tab3&#39;)">

Woodlands

</li>

<li class="tab" onclick="showTab(&#39;tab4&#39;)">

Choa Chu Kang

</li>

<li class="tab" onclick="showTab(&#39;tab5&#39;)">
...
<li class="tab active" onclick="showTab2(&#39;ta2b1&#39;)">

Changi

</li>

<li class="tab" onclick="showTab2(&#39;ta2b2&#39;)">

Town

</li>

<li class="tab" onclick="showTab2(&#39;ta2b3&#39;)">

Woodlands

</li>

<li class="tab" onclick="showTab2(&#39;ta2b4&#39;)">

Choa Chu Kang

</li>

<li class="tab" onclick="showTab2(&#39;ta2b5&#39;)">
...
function showTab2(tabId) {
  ...
  var tabContents = document.querySelectorAll('.tab-content2');
  tabContents.forEach(function(content) {
    if (content.id !== tabId) {
      content.classList.remove('active');
    }
