...
Figure above reveals that there is five hot spot area and two cold spot areas. Interestingly, the hot spot & cold spot areas patterns coincide with the cluster identifies by using local Moran’s I method in the earlier sub-section.

## Getting Top Hotspot Village for Man-Kendall Test
```{r}
