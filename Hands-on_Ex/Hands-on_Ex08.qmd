...
::: callout-note
[describe()](https://www.rdocumentation.org/packages/Hmisc/versions/4.4-0/topics/describe) of [psych](https://cran.r-project.org/web/packages/psych/) package is used here instead of summary() of Base R because the earlier provides standard deviation.
:::
